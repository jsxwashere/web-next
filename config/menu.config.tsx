...
/**
 * Sprint 2 — tek sidebar menü (ŞantiyePro modülleri).
 *
 * Karar: 2-katmanlı sidebar DEĞİL — proje içindeki alt modüller
 * `app/(protected)/projects/[projectId]/layout.tsx` içindeki
 * `<ProjectTabs />` ile gösterilir.
 *
 * Menü öğeleri sadece "üst düzey ŞantiyePro modülleri"ni içerir:
 * Pano, Projeler, Tahsilatlar, Ödemeler, Sözleşmeler, Personel,
 * Firmalar, Malzeme, Hakediş, Raporlar, Ayarlar.
 */
export const MENU_SHELL: MenuConfig = [
  { heading: 'Genel' },
  {
    title: 'Pano',
    icon: LayoutGrid,
  ...
  },
  {
    ...
    icon: Users,
    children: [
      { title: 'Liste', path: '/personel' },
      { title: 'Mesai', path: '/personel/mesai', disabled: true },
      { title: 'Bordro', path: '/personel/bordro', disabled: true },
    ],
  },
  {
    title: 'Firmalar',
    icon: BuildingIcon,
    children: [
      { title: 'Tedarikçiler', path: '/firmalar/tedarikciler' },
      { title: 'Taşeronlar', path: '/firmalar/taseronlar' },
      { title: 'Bayiler', path: '/firmalar/bayiler' },
    ],
  },
  {
    title: 'Malzeme',
    icon: BoxIcon,
    children: [
      { title: 'Stok', path: '/malzeme/stok' },
      { title: 'Talepler', path: '/malzeme/talepler', disabled: true },
      { title: 'Sevkiyat', path: '/malzeme/sevkiyat', disabled: true },
    ],
  },
  {
    title: 'Hakediş',
    icon: ClipboardList,
    children: [
      { title: 'Liste', path: '/hakedis' },
      { title: 'Onay Bekleyen', path: '/hakedis/onay', disabled: true },
    ],
  },
  {
    title: 'Raporlar',
    ...
    children: [
      { title: 'Genel', path: '/raporlar' },
      { title: 'Finans', path: '/raporlar/finans', disabled: true },
      { title: 'Maliyet Analizi', path: '/raporlar/maliyet', disabled: true },
    ],
  },
  { heading: 'Yönetim' },
  {
    ...
    icon: Settings,
    children: [
      { title: 'Genel', path: '/settings' },
      { title: 'Profil', path: '/settings/profile' },
      { title: 'Bildirimler', path: '/settings/notifications', disabled: true },
    ],
  },
  {
    title: 'Yardım',
...
// Re-export ŞantiyePro module aliases for shell consumers.
export {
  Bolt,
  Briefcase,
  CalendarCheck,
